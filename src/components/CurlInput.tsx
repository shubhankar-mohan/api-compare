...
export function CurlInput({ onSubmit, isLoading }: CurlInputProps) {
  ...
  const truncateCommand = (command: string, command2: string, maxLength = 50) => {
    ...
    const b = firstLine2.length > maxLength ? firstLine.substring(0, maxLength) + "...": firstLine2;
    return a + '\n' + b;
  };
    ...
    <Card className="overflow-hidden border-0 shadow-lg">
      ...
      <CardContent className="pt-6">
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 !mt-3">
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <Label htmlFor="curl-input" className="text-sm font-semibold">cURL Command A</Label>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <Label htmlFor="localhost-url" className="text-sm font-semibold">cURL Command B</Label>
                <div className="flex items-center gap-1">
                  <Button
                    type="button"
                    variant="ghost"
          ...
          <Button 
            type="submit" 
            disabled={isLoading || (curlCommand.length == 0 && localhostUrl.length == 0)}
